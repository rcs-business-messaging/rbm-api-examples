...
/**
 * RCSBusinessMessaging request.
 *
 * @since 1.3
 */
@SuppressWarnings("javadoc")
public abstract class RCSBusinessMessagingRequest<T> extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClientRequest<T> {
   ...
   */
  public RCSBusinessMessagingRequest(
      RCSBusinessMessaging client, String method, String uriTemplate, Object content, Class<T> responseClass) {
    super(
        client,
        method,
        uriTemplate,
  ...
  public final RCSBusinessMessaging getAbstractGoogleClient() {
    return (RCSBusinessMessaging) super.getAbstractGoogleClient();
  }

  @Override
  public RCSBusinessMessagingRequest<T> setDisableGZipContent(boolean disableGZipContent) {
    return (RCSBusinessMessagingRequest<T>) super.setDisableGZipContent(disableGZipContent);
  }

  @Override
  public RCSBusinessMessagingRequest<T> setRequestHeaders(com.google.api.client.http.HttpHeaders headers) {
    return (RCSBusinessMessagingRequest<T>) super.setRequestHeaders(headers);
  }

  @Override
  public RCSBusinessMessagingRequest<T> set(String parameterName, Object value) {
    return (RCSBusinessMessagingRequest<T>) super.set(parameterName, value);
  }
}
